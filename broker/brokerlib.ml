...
let template_descriptor_bridge =
  ([%scamltype: BrokerTypes.template_descriptor] :> _ tzbridge)

let spirit_descriptor_bridge =
  ([%scamltype: BrokerTypes.spirit_descriptor] :> _ tzbridge)
